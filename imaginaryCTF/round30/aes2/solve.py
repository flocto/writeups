...
ct = bytes.fromhex('d6037ea038e8232cabf6a372122c18ebc6136eb028f8333cbbe6b362023c08fb')
flag = bytes.fromhex('bf501dd2439d134ac681d72d4d4f2883bd5c0ac44ad84d1cf497c51c4d73799b895c0b900b851241d9829341735f689fb80875ab45e32802a0fd8d79190213e0')
# (well we only really care about first block)
zerod, test = ct[:16], ct[16:]

dec = b''
for block in split_blocks(flag):
    d = bytes2matrix(strxor(zerod, block))
    inv_shift_rows(d)
    dec += matrix2bytes(d)
print(dec)